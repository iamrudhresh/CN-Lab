...
### 5. Write a program to implement the DNS using UDP sockets. The DNS should have different domains with corresponding IP addresses. Resolve the user given domain with the IP and display it to the user. Also indicate the error message to the user when domain is not resolved.
```java
import java.io.*;
import java.net.*;
